...
/** Nota do stem de voz transcrita para MIDI (extrator ≥ 0.5.0). */
@Entity
@Table(name = "vocal_note")
public class VocalNote {
    ...
    public VocalNote(AnalysisRun run, BigDecimal startS, BigDecimal endS, int midiPitch, Integer velocity) {
        this.run = run;
        this.startS = startS;
        this.endS = endS;
